...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Upload your resume, paste a job description, and get a tailored, ATS-friendly resume in seconds." },
      { property: "og:title", content: "AI Resume Tailor" },
      { property: "og:description", content: "Upload your resume, paste a job description, and get a tailored, ATS-friendly resume in seconds." },
